						...
						<li class="list-group-item">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo e(route('product/addToCartFromWishlist', ['id'=> $product['item']['id']])); ?>" role="button">Add to Cart</a></li>
									<!-- REMOVE FROM WISH LIST -->
									<li><a href="<?php echo e(route('product/removeFromWishList', ['id'=> $product['item']['id']])); ?>">Remove</a></li>
									<li><a href="<?php echo e(route('product/removeAllWishlistItem', ['id'=> $product['item']['id']])); ?>">Remove All</a></li>
								</ul>
							</div>
						</li>
